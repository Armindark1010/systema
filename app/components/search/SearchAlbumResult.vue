...
// ============================================================
// SearchAlbumResult — compact album result row
// ============================================================
...
const props = defineProps<{
  result: ScoredSearchResult<Album>
  artistName: string
  cover?: string
}>()
...
const album = computed(() => props.result.item)
</script>
  ...
  <article class="search-entity-row">
    ...
    >
      ...
      <div class="search-entity-meta">
        <span class="search-entity-title">{{ album.title }}</span>
        <span class="search-entity-subtitle">{{ artistName }} · {{ album.year }}</span>
      </div>
    </button>
